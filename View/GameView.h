...
// Selects a random enemy image from a predefined list.
    ...
    sf::Text& getEnemyHealthText();

    sf::Text& getCardPlayedText();
    sf::RectangleShape& getSituation();
    sf::Sprite& getBackArrowSprite();
    sf::Text& getBackArrowText();
    sf::Sprite& getVictorySprite();
    sf::Sprite& getDefeatSprite();
    sf::Font& getFont();
};
